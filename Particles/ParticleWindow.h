...
class ParticleWindow : public BDirectWindow {

public:
		// standard constructor and destrcutor
				ParticleWindow(BRect frame, const char *name); 
virtual			~ParticleWindow();
...
static	long	ParticleAnimation(void *data);
